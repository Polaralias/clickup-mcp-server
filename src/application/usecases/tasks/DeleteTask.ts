import { z } from "zod";
import { DeleteTaskInput, CreateTaskOutput } from "../../../mcp/tools/schemas/taskCrud.js";
...
type InputType = z.infer<typeof DeleteTaskInput>;
...
export class DeleteTask {
  ...
  async execute(ctx: unknown, input: InputType): Promise<Result<z.infer<typeof CreateTaskOutput>>> {
    ...
    try {
      const response = await this.gateway.delete_task(data.taskId);
