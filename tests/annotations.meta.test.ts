...
describe("Tool annotations", () => {
  it("enforce mutation and deletion metadata policies", async () => {
    ...
    const cases: [string, { readOnlyHint: boolean; idempotentHint: boolean; destructiveHint: boolean }][] = [
      ...
      ["clickup_create_doc", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_update_doc_page", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_create_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_update_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_move_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_duplicate_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_comment_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_attach_file_to_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_add_tags_to_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_remove_tags_from_task", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_start_timer", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
      ["clickup_create_time_entry", { readOnlyHint: false, idempotentHint: false, destructiveHint: false }],
